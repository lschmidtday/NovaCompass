...
const contractABI = require("../artifacts/contracts/Novacompass.sol/Novacompass.json").abi;

program
    .name("novacompass-cli")
    .description("CLI tool for Novacompass smart contract")
    .version("1.0.0");
